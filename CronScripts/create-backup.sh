...
zip -j /qbittorrentConfig/qbittorrent_backup_${TIMESTAMP}.zip /qbittorrentConfig/qBittorrent/qBittorrent.conf /qbittorrentConfig/qBittorrent/categories.json